...
const SEEDS = [
  {
    ...
    packSizes: [
      { label: "1 г (~250 сем.)", price: 2.20, unit: "€ 2.20 / пакет", default: true },
      { label: "5 г", price: 7.50, unit: "€ 7.50 / 5 г" },
      { label: "50 г", price: 42.00, unit: "€ 42.00 / 50 г" }
    ],
    rating: 5.0,
    reviewsCount: 145,
    inStock: true
  },
  {
    ...
    packSizes: [
      { label: "50 семена", price: 4.80, unit: "€ 4.80 / пакет", default: true },
      { label: "250 семена", price: 18.90, unit: "€ 18.90 / 250 бр." },
      { label: "1000 семена", price: 62.00, unit: "€ 62.00 / 1000 бр." }
    ],
    rating: 5.0,
    reviewsCount: 118,
    inStock: true
  },
  {
    ...
    packSizes: [
      { label: "1 г", price: 1.80, unit: "€ 1.80 / 1 г", default: true },
      { label: "5 г", price: 6.20, unit: "€ 6.20 / 5 г" }
    ],
    rating: 4.9,
    reviewsCount: 89,
    inStock: true
  },
  {
    ...
    packSizes: [
      { label: "3 г (~100 сем.)", price: 1.60, unit: "€ 1.60 / пакет", default: true },
      { label: "10 г", price: 4.20, unit: "€ 4.20 / 10 г" }
    ],
    rating: 4.9,
    reviewsCount: 97,
    inStock: true
  },
  {
    ...
    packSizes: [
      { label: "1 г", price: 3.90, unit: "€ 3.90 / 1 г", default: true },
      { label: "5 г", price: 14.50, unit: "€ 14.50 / 5 г" }
    ],
    rating: 5.0,
    reviewsCount: 62,
    inStock: true
  },
  {
    ...
    packSizes: [
      { label: "2 г (~300 сем.)", price: 1.90, unit: "€ 1.90 / пакет", default: true },
      { label: "10 г", price: 6.50, unit: "€ 6.50 / 10 г" }
    ],
    rating: 5.0,
    reviewsCount: 133,
    inStock: true
  },
  {
    ...
    packSizes: [
      { label: "3 г", price: 1.70, unit: "€ 1.70 / 3 г", default: true },
      { label: "20 г", price: 7.90, unit: "€ 7.90 / 20 г" }
    ],
    rating: 4.9,
    reviewsCount: 78,
    inStock: true
  },
  {
    ...
    packSizes: [
      { label: "5 г", price: 2.10, unit: "€ 2.10 / 5 г", default: true },
      { label: "20 г", price: 6.80, unit: "€ 6.80 / 20 г" }
    ],
    rating: 4.8,
    reviewsCount: 45,
    inStock: true
  },
  {
    ...
    packSizes: [
      { label: "10 г", price: 1.40, unit: "€ 1.40 / 10 г", default: true },
      { label: "50 г", price: 4.50, unit: "€ 4.50 / 50 г" },
      { label: "500 г", price: 18.00, unit: "€ 18.00 / 500 г" }
    ],
    rating: 4.9,
    reviewsCount: 38,
    inStock: true
  },
  {
    ...
    packSizes: [
      { label: "5 г", price: 1.50, unit: "€ 1.50 / 5 г", default: true },
      { label: "20 г", price: 4.80, unit: "€ 4.80 / 20 г" }
    ],
    rating: 4.8,
    reviewsCount: 52,
    inStock: true
